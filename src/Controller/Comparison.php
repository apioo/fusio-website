...
class Comparison extends ControllerAbstract
{
    ...
    public function detail(string $app): mixed
    {
        ...
        $data = [
            ...
            'description' => 'Compare Fusio with ' . ucfirst($type) . '.',
            'keywords' => 'Fusio, API management, ' . ucfirst($type) . ', open-source API platform, self-hosted API, API development, API comparison, Fusio vs ' . ucfirst($type) . ', API management platforms',
