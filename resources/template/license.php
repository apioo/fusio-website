      ...
      <div class="col">
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <a href="<?php echo $router->getAbsolutePath([\App\Controller\Contact::class, 'show']); ?>" class="w-100 btn btn-lg btn-primary">Contact</a>
          </div>
        </div>
      </div>
      <div class="col-md"></div>
  ...
  <div class="row">
    <div class="col">
      ...
      <p>With this license choice we are following the footsteps of great projects like Wordpress or Nextcloud. Like Wordpress
        ...
        <a href="<?php echo $router->getAbsolutePath([\App\Controller\Contact::class, 'show']); ?>">contact</a> page.</p>
    </div>
  </div>
</div>
