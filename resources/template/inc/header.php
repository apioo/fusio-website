...
<head>
    ...
    <meta name="keywords" content="<?php echo $keywords ?? 'API, API Gateway, API Management, API Platform, AI Management, REST API, Agentic, Backend, MCP'; ?>"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <meta property="og:url" content="<?php echo $canonical; ?>"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="<?php echo $title !== null ? $title : 'Fusio | Open Source API & AI Management'; ?>"/>
    ...
    <nav class="fixed top-0 w-full z-50 border-b border-white/5 backdrop-blur-xl bg-slate-950/80">
        <div class="container mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3 sm:gap-6">
                <a href="https://github.com/apioo/fusio" target="_blank" class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-orange-500/50 transition-all group">
                ...
                <a href="<?php echo $router->getAbsolutePath([\App\Controller\Demo::class, 'show']); ?>" class="inline-block bg-orange-500 text-slate-950 px-5 py-2.5 rounded-full text-sm font-bold hover:bg-orange-300 hover:shadow-orange-500/40 transition-all shadow-lg shadow-orange-500/20">
                    Demo
                </a>
            </div>
        </div>
